...
# is 0(n log n) if unsorted, is O(n^2) if sorted, so must make sure data's not sorter prior
# if data is potentially sorted, it might be better to run insertion sort its worst is 0n2 but best is On
